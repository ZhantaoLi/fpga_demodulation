...
HD_PWD='D:/Project/ZYNQ/7035/test2023/test2023.runs/design_1_MOV_RMS_FM_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_MOV_RMS_FM_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_MOV_RMS_FM_1.tcl
