...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/bd_36cd.protoinst" -protoinst "protoinst_files/bd_ac61.protoinst" -protoinst "protoinst_files/bd_6de0.protoinst" -protoinst "protoinst_files/bd_a0b7.protoinst" -protoinst "protoinst_files/bd_d860.protoinst" -protoinst "protoinst_files/bd_6076.protoinst" -protoinst "protoinst_files/bd_53e6.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
