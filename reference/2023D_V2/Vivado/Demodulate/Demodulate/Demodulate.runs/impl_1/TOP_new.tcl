...
set rc [catch {
  ...
  add_files -quiet C:/Users/86183/Desktop/dianSai/2023_D/Vivado/Demodulate/Demodulate/Demodulate.runs/synth_1/TOP_new.dcp
  ...
  link_design -top TOP_new -part xc7a35tfgg484-2
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force TOP_new_physopt.dcp
