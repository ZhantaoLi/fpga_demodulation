...
HD_PWD='C:/Users/86183/Desktop/dianSai/2023_D/Vivado/Demodulate/Demodulate/Demodulate.runs/dist_mem_ph_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_ph.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_ph.tcl
