...
#
# Generated by export_simulation on Thu Aug 03 14:04:30 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dist_mem_ph.sh' script.

./dist_mem_ph.sh -reset_run
...
./dist_mem_ph.sh -noclean_files

For more information on the script, please type './dist_mem_ph.sh -help'.
