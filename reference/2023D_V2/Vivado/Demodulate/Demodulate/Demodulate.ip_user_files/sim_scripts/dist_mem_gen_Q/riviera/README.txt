...
#
# Generated by export_simulation on Thu Aug 03 14:12:31 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dist_mem_gen_Q.sh' script.

./dist_mem_gen_Q.sh -reset_run
...
./dist_mem_gen_Q.sh -noclean_files

For more information on the script, please type './dist_mem_gen_Q.sh -help'.
