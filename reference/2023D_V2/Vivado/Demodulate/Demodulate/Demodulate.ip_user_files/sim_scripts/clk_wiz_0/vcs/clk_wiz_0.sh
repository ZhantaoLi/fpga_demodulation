...
#
# Generated by Vivado on Thu Aug 03 19:01:38 +0800 2023
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Demodulate.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Demodulate.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../Demodulate.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
