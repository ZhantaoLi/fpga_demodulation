...
#
# Generated by export_simulation on Wed Aug 02 21:57:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dist_mem_gen_I.sh' script.

./dist_mem_gen_I.sh -reset_run
...
./dist_mem_gen_I.sh -noclean_files

For more information on the script, please type './dist_mem_gen_I.sh -help'.
