...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "fm_fir_b_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "fm_fir_b_st" "LOGIC ELEMENTS"
}
add_fir_constraints
